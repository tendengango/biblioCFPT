...
class LibrariansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create librarian" do
    assert_difference('Librarian.count') do
      post librarians_url, params: { librarian: { approved: @librarian.approved, email: @librarian.email, name: @librarian.name, password: @librarian.password } }
    end
  ...
  test "should update librarian" do
    patch librarian_url(@librarian), params: { librarian: { approved: @librarian.approved, email: @librarian.email, name: @librarian.name, password: @librarian.password } }
